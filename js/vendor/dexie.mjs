/* Generated by scripts/sync-vendor-libs.mjs from dexie@4.3.0. License: Apache-2.0. */
...
// dexie-vendor-entry.js
var dexie_vendor_entry_default = import_wrapper_default;
export {
  dexie_vendor_entry_default as default
};
